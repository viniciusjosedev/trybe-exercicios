...
-- 15 - Escreva uma query que exiba a string “Existem Number cientistas na tabela Scientists.”, em que Number se refira a quantidade de cientistas.
 SELECT CONCAT('Existem ', Contador, ' cientistas na tabela Scientists.') AS 'Quantidade de Ciêntistas' FROM (SELECT COUNT(Name) AS Contador FROM Scientists.Scientists)Contador;
