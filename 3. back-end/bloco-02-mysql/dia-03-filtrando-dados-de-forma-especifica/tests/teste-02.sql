...
SELECT CONCAT('A peça 1 é provida por ', Empresas, ' empresas') AS Informações FROM (SELECT COUNT(Piece) AS Empresas FROM PiecesProviders.Provides WHERE Piece = 1 OR Piece = 2)Empresas;
